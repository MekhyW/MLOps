...
acc = px.bar(accuracy_by_date, x="date", y="accuracy", title="Model Performance Over Time")
acc.show()
...
acc_noise = px.bar(accuracy_by_date_noise, x="date", y="accuracy", color="accuracy", title="Performance Decrease Over Time")
acc_noise.show()